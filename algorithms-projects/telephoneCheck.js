...
function telephoneCheck(str) {
    const regex1 = /^(1 )?[0-9][0-9][0-9]-[0-9][0-9][0-9]-[0-9][0-9][0-9][0-9]$/
    const regex2 = /^(1 )?[(][0-9][0-9][0-9][)][0-9][0-9][0-9]-[0-9][0-9][0-9][0-9]$/
    const regex3 = /^(1 *)?[(][0-9][0-9][0-9][)] *[0-9][0-9][0-9]-[0-9][0-9][0-9][0-9]$/
    const regex4 = /^(1 )?[0-9][0-9][0-9] [0-9][0-9][0-9] [0-9][0-9][0-9][0-9]$/
    const regex5 = /^(1 )?[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]$/
    const regex6 = /^(1 )?[0-9][0-9][0-9] [0-9][0-9][0-9] [0-9][0-9][0-9][0-9]$/
    const regexArr = [regex1,regex2,regex3,regex4,regex5,regex6]
    return regexArr.some(reg => reg.test(str))
  }
